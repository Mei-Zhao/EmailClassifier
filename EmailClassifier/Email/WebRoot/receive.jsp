...
<html>
  ...
  <body>
    <p align="left"><strong>收件箱</strong></p>
   ...
   <jsp:useBean id="dopage" class="org.logical.doPage" />
	...
	<%
	List<Message> list= dopage.selectByUser2(name,pageNow,pageSize);
	...
	<td> <a href="delete.jsp?id=<%= me.getId()%>&username=<%= request.getParameter("username")%>">删除</a> </td>
	<%}%>
	</table>
