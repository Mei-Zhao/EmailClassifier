...
<html>
  ...
  <body>
   <p align="center"><strong>写邮件</strong></p>
    ...
    <input type="hidden" name="action" value="write" >
   	<table width="600"border="0" align="center" cellpadding="2" cellspacing="10">
   		<tr>
   			...
   			<td ><input type="text" name="sender" size="65" readonly="readonly" value=<%= request.getParameter("username")%>></td>
   		</tr>
   		<tr>
   			<td height="30" align="center">收件人</td>
   			<td><input type="text" name="receiver" size="65"></td>
   		</tr>
   		<tr>
   			<td height="30"align="center">主题</td>
   			<td ><input type="text" name="theme" size="65"></td>
   		</tr>
		<tr >
